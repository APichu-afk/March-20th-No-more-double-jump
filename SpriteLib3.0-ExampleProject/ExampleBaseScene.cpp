...
void ExampleBaseScene::InitScene(float windowWidth, float windowHeight)
{
	...
	//Setup new Entity Box Main Player
	{
		...
		ECS::GetComponent<Sprite>(entity).LoadSprite(fileName, 112 / 6, 117 / 6, true, &animController);
		ECS::GetComponent<Sprite>(entity).SetUVs(vec2(1.f, 117.f), vec2(112.f, 1.f));
		ECS::GetComponent<Transform>(entity).SetPosition(vec3(0.f, 0.f, -7.f));
	...
	//Ground
	{
		...
		ECS::GetComponent<Transform>(entity).SetPosition(-50.f, -65.f, -8.f);
		...
		tempDef.position.Set(float32(-50.f), float32(-65.f));
...

	{
		...
		ECS::GetComponent<Sprite>(entity).LoadSprite(fileName, 100 * 7, 45 * 6);
...

	{
		...
		//ECS::GetComponent<Sprite>(entity).LoadSprite(fileName, 100 * 5, 45 * 5);
		ECS::GetComponent<Sprite>(entity).LoadSprite(fileName, 1024/3, 608/4);
		ECS::GetComponent<Transform>(entity).SetPosition(vec3(0.f, 60.f, -9.f));
...

	{
		...
		ECS::GetComponent<Transform>(entity).SetPosition(vec3(0.f, 0.f, 10));
